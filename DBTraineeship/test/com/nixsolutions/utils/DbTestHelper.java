...
public class DbTestHelper {
    ...
    protected static final String SQL_CREATE_CHEMA = "resources/sql/Create scheme.sql";
    protected static final String SQL_CREATE_TABLE_ROLE = "resources/sql/Create table ROLE.sql";
    protected static final String SQL_CREATE_TABLE_USER = "resources/sql/Create table USER.sql";
